...
% For temporal data, repeat each day/month for all points
days_CMS = [];
months_CMS = [];
for i = 1:num_releases
    days_CMS = [days_CMS; repmat(filtered_days(i), numpoints, 1)];
    months_CMS = [months_CMS; repmat(filtered_months(i), numpoints, 1)];
end
