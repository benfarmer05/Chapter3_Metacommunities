%ben farmer note: our ROMS grid files have S-coordinate stretching curve
%global variables already. does this mean 'set_depth' doesn't really need
%to call 'stretching'? we might be able to provide 'set_depth' with what it
%needs directly [update, Dan says probably fine since Sonaljit's ROMS 
%configuration likely calculated stretching the same way as here]
