...
% Plot every single USCROMS coordinate
h_rho = plot(longitudes_rho_USCROMS(:), latitudes_rho_USCROMS(:), 'or', 'MarkerSize', 3);xlim([360-65.1, 360-64.8]);ylim([18.2, 18.5]);hold on % Red circles for every single USCROMS coordinate
