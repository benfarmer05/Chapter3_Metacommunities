%% Ben Farmer output 03/15/2021 - slight update 7 march 2022
cd '/Users/benja/Library/CloudStorage/Box-Box/Big_Projects/VI_ROMS/MATLAB-Drive_backup-17Feb2022/USVI/Connectivity'
trajecty = 'traj_file_505.nc';
ncdisp(trajecty)
...
% NOTE all this was changed a million
% times by dan so just go ahead and go back to fix this lol
for k = 1:length(Locs)
